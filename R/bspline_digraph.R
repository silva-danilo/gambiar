...
grViz(paste0('
  digraph boxes_and_circles{
    ...
    B_9_2 -> B_9_1 [label=', index_cool('a',9,2), ']
    B_9_2 -> B_10_1 [label=', index_cool('b',9,2), ']
    B_9_1 -> B_9_0 [label=', index_cool('a',9,1), ']
    B_9_1 -> B_10_0 [label=', index_cool('b',9,1), ']
    B_10_1 -> B_10_0 [label=', index_cool('a',10,1), ']
    B_10_1 -> B_11_0 [label=', index_cool('b',10,1), ']
    B_9_0 -> B_9_base [label=', index_cool('a',9,0), ']
    B_9_0 -> B_10_base [label=', index_cool('b',9,0), ']
    B_10_0 -> B_10_base [label=', index_cool('a',10,0), ']
    B_10_0 -> B_11_base [label=', index_cool('b',10,0), ']
    B_11_0 -> B_11_base [label=', index_cool('a',11,0), ']
    B_11_0 -> B_12_base [label=', index_cool('b',11,0), ']
  }
'))
